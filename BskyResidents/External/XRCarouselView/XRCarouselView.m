...
- (void)setImageArray:(NSArray *)imageArray{
    ...
    for (int i = 0; i < imageArray.count; i++) {
        if ([imageArray[i] isKindOfClass:[UIImage class]]) {
            ...
            [_images addObject:[UIImage imageNamed:@"banner1"]];
...
#pragma mark imageView的ContentMode

- (void)setImageViewContentMode:(UIViewContentMode)imageViewContentMode
{
    if (self.scrollView) {
        self.currImageView.contentMode = imageViewContentMode;
        self.otherImageView.contentMode = imageViewContentMode;
        self.currImageView.clipsToBounds = YES;
